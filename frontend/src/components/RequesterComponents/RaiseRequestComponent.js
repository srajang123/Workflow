...
class RaiseRequest extends Component {
    ...
    async componentDidMount() {
        ...
        const productResponse = await axios.get(process.env.REACT_APP_PRODUCTS_GET_API);
        ...
        if (productResponse.status === 200) {
            ...
            const approverResponse = await axios.get(process.env.REACT_APP_APPROVERS_GET_API);
    ...
    handleSubmit = async (event) => {
        ...
        if (clientSideVerification) {
            ...
            if (clientSideVerification) {
                ...
                axios.post(process.env.REACT_APP_REQUESTER_NEW_API, {
